...
class ExploreAlbumController extends Controller implements ControllerInterface
{
        ...
        try{
            switch($_SERVER['REQUEST_METHOD']){
                case 'GET':
                    ...
                    if($res && $total_page){
                        $AlbumView = $this->view('explore', 'ExploreAlbumView', ['username' => $user, 'admin' => $isAdmin, 'current_page' => $page, 'total_page' => $total_page, 'albums' => $res]);
                        ob_start();
                        $AlbumView->render();
                        $return = ob_get_clean();
